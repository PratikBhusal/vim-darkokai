function! darkokai#colors#gui#get_colors()
    ...
    return {
        ...
        \ 'diffadd'    : { 'gui' : get( s:overrides, 'diffadd',    '#3d5214' ) },
        \ 'diffchange' : { 'gui' : get( s:overrides, 'diffchange', '#143152' ) },
        \ 'difftext'   : { 'gui' : get( s:overrides, 'difftext',   '#e6cf00' ) },
        \ 'diffdel'    : { 'gui' : get( s:overrides, 'diffdel',    '#52142a' ) },
